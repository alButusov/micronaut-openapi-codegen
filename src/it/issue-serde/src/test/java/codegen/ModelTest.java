...
public class ModelTest {
	...
	void readSerializedDogString() {
		var serializedString = assertDoesNotThrow(() -> mapper.writeValueAsString(dogObject))
		assertEquals(parentObject, assertDoesNotThrow(() -> mapper.readValue(serialized, Parent.class)));
	}
}
